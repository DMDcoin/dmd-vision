...
using DMDVision.Contracts.BlockRewardHbbftBase.ContractDefinition;

namespace DMDVision.Contracts.BlockRewardHbbftBase
{
    public partial class BlockRewardHbbftBaseService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, BlockRewardHbbftBaseDeployment blockRewardHbbftBaseDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<BlockRewardHbbftBaseDeployment>().SendRequestAndWaitForReceiptAsync(blockRewardHbbftBaseDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, BlockRewardHbbftBaseDeployment blockRewardHbbftBaseDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<BlockRewardHbbftBaseDeployment>().SendRequestAsync(blockRewardHbbftBaseDeployment);
        }

        public static async Task<BlockRewardHbbftBaseService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, BlockRewardHbbftBaseDeployment blockRewardHbbftBaseDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, blockRewardHbbftBaseDeployment, cancellationTokenSource);
            return new BlockRewardHbbftBaseService(web3, receipt.ContractAddress);
        }
        ...
        public BlockRewardHbbftBaseService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;

...
using DMDVision.Contracts.StakingHbbftBase.ContractDefinition;

namespace DMDVision.Contracts.StakingHbbftBase
{
    public partial class StakingHbbftBaseService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, StakingHbbftBaseDeployment stakingHbbftBaseDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<StakingHbbftBaseDeployment>().SendRequestAndWaitForReceiptAsync(stakingHbbftBaseDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, StakingHbbftBaseDeployment stakingHbbftBaseDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<StakingHbbftBaseDeployment>().SendRequestAsync(stakingHbbftBaseDeployment);
        }

        public static async Task<StakingHbbftBaseService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, StakingHbbftBaseDeployment stakingHbbftBaseDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, stakingHbbftBaseDeployment, cancellationTokenSource);
            return new StakingHbbftBaseService(web3, receipt.ContractAddress);
        }
        ...
        public StakingHbbftBaseService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;

...
using DMDVision.Contracts.StakingHbbft.ContractDefinition;

namespace DMDVision.Contracts.StakingHbbft
{
    public partial class StakingHbbftService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, StakingHbbftDeployment stakingHbbftDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<StakingHbbftDeployment>().SendRequestAndWaitForReceiptAsync(stakingHbbftDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, StakingHbbftDeployment stakingHbbftDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<StakingHbbftDeployment>().SendRequestAsync(stakingHbbftDeployment);
        }

        public static async Task<StakingHbbftService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, StakingHbbftDeployment stakingHbbftDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, stakingHbbftDeployment, cancellationTokenSource);
            return new StakingHbbftService(web3, receipt.ContractAddress);
        }
        ...
        public StakingHbbftService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
